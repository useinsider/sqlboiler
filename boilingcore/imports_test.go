...
func TestCombineImports(t *testing.T) {
	...
	a := imports{
		...
		thirdParty: importList{"github.com/useinsider/sqlboiler", "gopkg.in/volatiletech/null.v6"},
	}
	b := imports{
		standard:   importList{"os"},
		thirdParty: importList{"github.com/useinsider/sqlboiler"},
	}
	...
	if c.thirdParty[0] != "github.com/useinsider/sqlboiler" && c.thirdParty[1] != "gopkg.in/volatiletech/null.v6" {
		t.Errorf("Wanted: github.com/useinsider/sqlboiler, gopkg.in/volatiletech/null.v6 got: %#v", c.thirdParty)
	}
}
