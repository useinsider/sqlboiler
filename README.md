...
[![License](https://img.shields.io/badge/license-BSD-blue.svg)](https://github.com/useinsider/sqlboiler/blob/master/LICENSE)
[![GoDoc](https://godoc.org/github.com/useinsider/sqlboiler?status.svg)](https://godoc.org/github.com/useinsider/sqlboiler)
...
import (
  ...
  . "github.com/useinsider/sqlboiler/queries/qm"
)
...
```shell
go get -u -t github.com/useinsider/sqlboiler
```
...
Complete documentation is available at http://github.com/useinsider/sqlboiler
...
import . "github.com/useinsider/sqlboiler/queries/qm"
...
For a comprehensive ruleset for `Bind()` you can refer to our [godoc](https://godoc.org/github.com/useinsider/sqlboiler/queries#Bind).
...
by using the [boil.Begin()](https://godoc.org/github.com/useinsider/sqlboiler/boil#Begin) function.
...
The homepage for the [SQLBoiler](https://github.com/useinsider/sqlboiler) [Golang ORM](https://github.com/useinsider/sqlboiler)
generator is located at: https://github.com/useinsider/sqlboiler

## Benchmarks

If you'd like to run the benchmarks yourself check out our [boilbench](https://github.com/useinsider/boilbench) repo.
